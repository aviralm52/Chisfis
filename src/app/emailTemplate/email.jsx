...
export const BookingTemplate = (bookingId) => {
  return `
	<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<!--[if (gte mso 9)|(IE)]><xml><o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml><![endif]-->
										...
										<tr>
											<td align="center" class="container-padding">
												<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%;max-width:100%;">
													...
													<tr>
														<td align="center" valign="middle" class="br-mobile-none" style="font-family:'Poppins', sans-serif;color:#FFFFFF;font-size:38px;line-height:48px;font-weight:400;letter-spacing:0px;">Booking Confirmation!</td>
													</tr>
													<tr>
														<td  style="font-size:15px;height:15px;line-height:15px;">&nbsp;</td>
													</tr>
										...
										<tr>
											<td align="center" class="container-padding">
												<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
													...
													<tr>
														<td align="left" valign="middle" style="font-family:'Poppins', sans-serif;color:#191919;font-size:18px;line-height:28px;font-weight:600;letter-spacing:0px;padding:0px;padding-bottom:20px;">Hello,</td>
													</tr>
													<tr>
														<td align="left" valign="middle" style="font-family: Poppins, sans-serif; color: #595959; font-size: 25px; line-height: 26px; font-weight: 600; letter-spacing: 0px; padding: 0px 0px 40px;">Confirm Your Booking<br>
                              <a href="${process.env.NEXT_PUBLIC_URL}/bookings/bookingConfirmation/${bookingId}" target="_blank" style="font-size: 16px; font-family: Arial, sans-serif; color: #212121; text-decoration: none; padding: 10px 20px; border-radius: 5px; border: 1px solid #FF9800; display: inline-block;">View Booking</a>
														<br>
														</br>
														<br>For any support please mail us on support@vacationsaga.com</td>
                                                        <br>  
...
export const BookingCancellationTemplate = (email) => {
  return `
	<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		<!--[if (gte mso 9)|(IE)]><xml><o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml><![endif]-->
										...
										<tr>
											<td align="center" class="container-padding">
												<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
													...
													<tr>
														<td align="left" valign="middle" style="font-family: Poppins, sans-serif; color: #595959; font-size: 16px; line-height: 26px; font-weight: 400; letter-spacing: 0px; padding: 0px 0px 40px;"><p style="font-size: 25px; font-weight:600; height: 0px; line-height: 0px;">Booking Cancelled By Owner</p>                         <br>  
													</tr>
													<tr>
														<td  style="font-size: 0px; height: 0px; line-height: 0px;">&nbsp;</td>
													</tr>
                      ...
                      <td align="center">
                        ...
                        >
                          <tr>
                            ...
                            >
                              <img
                                src="https://vacationsaga.b-cdn.net/assets/greenTick-bgRemoved.png"
                                border="0"
                                width="600"
                                alt="Header"
                                style="
                            ...
                            <td align="center" valign="middle">
                              ...
                              >
                                <tr>
                                  ...
                                  >
                                    <a
                                      href="www.vacationsaga.com/payment?pId=${propertyId}&amount=6&paymentToken=${paymentToken}"
                                      style="
                                        color: #e17e1d;
                                        font-family: Poppins, sans-serif;
                                        font-size: 14px;
