...
//       // </div>
//       <>
//         <h1>Related post will render here</h1>
//       </>
//     );
//   };
...
const Page = ({ params }: PageProps) => {
  ...
  return (
    <div className="p-2">
      <Link
        href="/blog"
        className="border sm:px-4 px-2 hidden   mt-2 sm:py-2 py-1 rounded-xl  border-neutral-200 hover:border-neutral-400 dark:border-neutral-700  items-center gap-x-1 sm:inline-flex dark:hover:border-neutral-500"
      >
      ...
      <Link
        href="/blog"
        className="border sm:hidden sm:px-4 px-2  mt-2 sm:py-2 py-1 rounded-xl  border-neutral-200 hover:border-neutral-400 dark:border-neutral-700  items-center gap-x-1 inline-flex dark:hover:border-neutral-500"
      >
        <BsArrowLeftShort size={18} />
      </Link>
